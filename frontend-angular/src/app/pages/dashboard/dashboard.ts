...
iaPrioridad = '';
  ...
  cargarTalleres() {
    this.http.get<any[]>('http://127.0.0.1:8000/talleres').subscribe({
      next: (data) => {
        this.talleres = data;
  ...
  cargarTecnicos() {
    this.http.get<any[]>('http://127.0.0.1:8000/tecnicos').subscribe({
      next: (data) => {
        this.tecnicos = data;
      },
      error: () => {
  ...
  registrarTecnico() {
    ...
    this.http.post('http://127.0.0.1:8000/tecnicos', data).subscribe({
      next: () => {
  ...
  cambiarDisponibilidadTecnico(id: number, disponibilidad: boolean) {
    this.http.put(`http://127.0.0.1:8000/tecnicos/${id}/disponibilidad`, {
      disponibilidad
    }).subscribe({
      next: () => {
  ...
  cargarVehiculos() {
    this.http.get<any[]>('http://127.0.0.1:8000/vehiculos').subscribe({
      next: (data) => {
  ...
  registrarVehiculo() {
    ...
    this.http.post('http://127.0.0.1:8000/vehiculos', data).subscribe({
      next: () => {
  ...
  registrarTaller() {
    ...
    this.http.post('http://127.0.0.1:8000/talleres', data).subscribe({
      next: () => {
  ...
  cargarIncidentes() {
    this.http.get<any[]>('http://127.0.0.1:8000/incidentes').subscribe({
      next: (data) => {
  ...
  crearIncidente() {
    ...
    this.http.post('http://127.0.0.1:8000/incidentes', data).subscribe({
      next: (res: any) => {
  ...
  aceptarIncidente(id: number) {
    this.http.put(`http://127.0.0.1:8000/incidentes/${id}/aceptar`, {}).subscribe({
      next: () => {
  ...
  rechazarIncidente(id: number) {
    this.http.put(`http://127.0.0.1:8000/incidentes/${id}/rechazar`, {}).subscribe({
      next: () => {
  ...
  asignarTecnico(idIncidente: number) {
    ...
    this.http.put(`http://127.0.0.1:8000/incidentes/${idIncidente}/asignar-tecnico`, {
  ...
  iniciarAtencion(idIncidente: number) {
    this.http.put(`http://127.0.0.1:8000/incidentes/${idIncidente}/iniciar-atencion`, {}).subscribe({
      next: () => {
  ...
  cambiarEstadoIncidente(id: number, estado: string) {
    this.http.put(`http://127.0.0.1:8000/incidentes/${id}/estado`, { estado }).subscribe({
      next: () => {
